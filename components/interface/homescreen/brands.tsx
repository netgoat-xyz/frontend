...
export default function Brands() {
  ...
  const brands = Array.from({ length: 6 }, () => t("comingSoon"));
  const marqueeBrands = [...brands, ...brands, ...brands];

  return (
    <section className="relative z-20 py-16 border-b border-border/60 overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 mb-10 text-center">
        <p className="text-[11px] font-light text-muted-foreground/70 uppercase tracking-[0.2em]">
          {t("title")}
        </p>
      </div>
      ...
      <div className="relative flex w-full overflow-hidden">
        ...
        >
          {marqueeBrands.map((brand, i) => (
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-foreground/5 border border-border/60" />

...
export default function Header() {
  ...
  return (
    <header className="relative z-50 flex items-center justify-between px-4 sm:px-6 md:px-10 py-4 sm:py-5">
      ...
      {/* --- Authentication Area --- */}
      <div className="relative flex items-start gap-2 justify-end min-w-0">
        <button
          onClick={() => setIsMobileNavOpen((v) => !v)}
          className="md:hidden h-8 w-8 inline-flex items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/80 hover:text-white hover:bg-white/10 transition-colors"
        ...
        {isPending ? (
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="md:hidden px-3 py-1.5 rounded-full bg-white text-black font-normal text-xs transition-colors hover:bg-white/90 h-8"
            >
              {t("login")}
            </button>
            <div

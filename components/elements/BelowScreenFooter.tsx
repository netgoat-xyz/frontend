...
export default function BelowScreenFooter() {
  ...
  useEffect(() => {
    fetch(
      "https://api.github.com/repos/netgoat-xyz/frontend/commits/Frontend-Rewrite",
    )
      .then((res) => res.json())
      .then((data) => {
        if (data.sha) {
  ...
  return (
    <footer className="relative mt-auto w-full z-20 max-w-340 py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-neutral-900/85 filter backdrop-blur border-t border-neutral-800/95">

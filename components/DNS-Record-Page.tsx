        ...
        <CardContent>
          <ul className="list-disc list-inside space-y-1">
            <li>
              ...
              <strong>www.{slug}</strong> resolves.
            </li>
            <li>
              Add an A, AAAA, or CNAME record for your root domain so that{" "}
              <strong>{slug}</strong> resolves.
            </li>
            <li>
              Add an MX record for your root domain so that mail can reach{" "}
              <strong>@{slug}</strong> addresses or set up SPF, DKIM, and DMARC
              records.
            </li>
          </ul>
        </CardContent>

  ...
  return (
    <div className="relative flex min-h-svh w-full flex-col items-center justify-center overflow-hidden bg-background font-sans text-foreground antialiased">
      ...
      <div className="z-10 flex max-w-md flex-col items-center space-y-8 px-4 text-center">
        ...
        <div className="group relative select-none mx-auto h-64 w-full overflow-hidden rounded-xl border border-border/60 shadow-xl transition-all duration-500 hover:border-border hover:shadow-2xl">
          <Image
            src="https://c.tenor.com/zXCbu7b7qA8AAAAd/tenor.gif"
            alt={t('imageAlt')}
            fill
            className="object-cover opacity-90 w-full transition-opacity duration-500 group-hover:opacity-100"
            unoptimized
          />
        </div>

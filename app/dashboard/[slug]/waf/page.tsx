...
const wafRules = [
  {
    ...
    name: "SQL Injection",
    status: true,
    description: "Blocks SQLi attempts",
  },
  {
    id: 2,
    name: "XSS Filter",
  ...
  },
  {
    ...
    name: "Rate Limiting",
    status: true,
    description: "Limits excessive requests",
  },
];
  ...
  return (
    ...
    >
      ...
      <TableCell>
        ...
        <span
          className={
            "ml-2 " + (rule.status ? "text-green-500" : "text-red-500")
          }
        >
          {rule.status ? "On" : "Off"}
        </span>
          ...
          <div className="p-6 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Protect your application from common web attacks. Toggle the
                  WAF or manage individual rules below.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
                  <DrawerContent>
                    <DrawerHeader>
                      ...
                      <DrawerDescription>
                        Define a new WAF rule. You can enter code for custom
                        logic.
                      </DrawerDescription>
                    </DrawerHeader>
                ...
                <div className="text-xs text-muted-foreground mt-2">
                  <b>Order matters:</b> Rules at the top are executed first,
                  those at the bottom last.
                </div>
              </CardContent>
            </Card>
          </div>

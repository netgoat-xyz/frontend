                ...
                <AnimatePresence initial={false}>
                  {filteredCerts.map((cert) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold ${statusColors[cert.status as keyof typeof statusColors] || ""}`}
                        >
